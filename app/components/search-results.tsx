...
export function SearchResults() {
  ...
  const handleFuelTypeChange = (value: string) => {
    setFuelType((prev) => (prev.includes(value) ? prev.filter((item) => item !== value) : [...prev, value]))
  }

  const handleLocationChange = (value: string) => {
    setLocation((prev) => (prev.includes(value) ? prev.filter((item) => item !== value) : [...prev, value]))
  }
      ...
      <div className="flex flex-col lg:flex-row gap-8 py-6">
        ...
        <div className="lg:hidden flex justify-between items-center mb-4">
          <Button variant="outline" onClick={toggleMobileFilters} className="flex items-center gap-2">
            Filters
            {mobileFiltersOpen ? <ChevronUp size={16} /> : <ChevronUp size={16} className="rotate-180" />}
          </Button>
        ...
        {/* Filters sidebar - fixed on desktop, collapsible on mobile */}
        <div className={`${mobileFiltersOpen ? "block" : "hidden"} lg:block lg:w-72 shrink-0`}>
            ...
            <div className="space-y-6">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="transmission">
                  <AccordionTrigger className="text-sm font-medium py-2">Transmission</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="fuel-type">
                  <AccordionTrigger className="text-sm font-medium py-2">Fuel type</AccordionTrigger>
                  <AccordionContent>
                    <div className="space-y-2 mt-2">
                      <div className="flex items-center">
                        <input
                    ...
                    <div className="space-y-2 mt-2">
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={() => handleLocationChange("london")}
                        />
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          id="manchester"
                          className="mr-2"
                          checked={location.includes("manchester")}
                          onChange={() => handleLocationChange("manchester")}
                        />
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          id="birmingham"
                          className="mr-2"
                          checked={location.includes("birmingham")}
                          onChange={() => handleLocationChange("birmingham")}
                        />
                        <label htmlFor="birmingham">Birmingham</label>
                      </div>
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          id="glasgow"
                          className="mr-2"
                          checked={location.includes("glasgow")}
                          onChange={() => handleLocationChange("glasgow")}
                        />
        ...
        <div className="flex-1" id="results-top">
          ...
          <div className="mb-6">
            <p className="text-sm text-muted-foreground">
              Showing {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, EXTENDED_CARS.length)} of {EXTENDED_CARS.length}{" "}
              results
            </p>
          </div>
